...
const components = {
  a: (props) => <a {...props} className="text-primary-500 hover:text-primary-600 underline underline-offset-2" target={props.href?.startsWith('http') ? '_blank' : undefined} rel={props.href?.startsWith('http') ? 'noopener noreferrer' : undefined} />,
