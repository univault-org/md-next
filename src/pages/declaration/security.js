...
export default function Security({ source, frontmatter }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
            ...
            <div className="prose prose-lg sm:prose-xl md:prose-2xl max-w-3xl mx-auto">
              <div className="text-white/90 dark:text-white/80 text-3xl sm:text-4xl md:text-5xl leading-relaxed font-serif">
                ...
                <p className="first-letter:text-[4.5rem] sm:first-letter:text-[5.5rem] md:first-letter:text-[6.5rem] 
                  ...
                  Strong security measures are essential for protecting personal
                  data. This includes implementing reliable encryption,
                  conducting regular security audits, and enforcing strict
                  access controls to prevent unauthorized access and breaches.
                  Just as a vault safeguards valuable possessions, robust
                  security practices ensure personal information remains safe
                  and intact. Advanced technologies and protocols are employed
                  to defend against potential threats, ensuring personal data is
                  protected at every stage—from generation and processing to
